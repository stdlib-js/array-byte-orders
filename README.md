...
```javascript
import byteOrders from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-byte-orders@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-byte-orders/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/array-byte-orders/actions/workflows/test.yml?query=branch:v0.1.1
